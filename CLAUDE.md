...
5. 1000 Expert Prompts ($4+, pay-what-you-want) — https://zerix1.gumroad.com/l/ybezdv. Source: `products/1000-expert-prompts/`. 10 kategori × 100 prompt (Marketing/SEO/Business/Dev/AI/Writing/Social/Data/Design/Career). Role-based + framework-powered + variable-driven.
...
7. Medium Income 2026 ($19) — https://zerix1.gumroad.com/l/bpevse. Source: `products/medium-income/`. 12 chapters, ~100-130pp PDF, beginner playbook for the 2026 Partner Program. Worldwide framing (100+ countries post-2024 expansion).
