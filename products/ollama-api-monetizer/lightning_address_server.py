#!/usr/bin/env python3
"""
Self-hosted Lightning Address Server (LNURL-pay).
...
Usage:
  DOMAIN=yourdomain.com LNBITS_URL=http://localhost:5000 LNBITS_API_KEY=xxx python3 lightning_address_server.py
"""
...
USERNAME = os.environ.get("LN_USERNAME", "user")
