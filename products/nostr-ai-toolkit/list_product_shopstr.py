...
Customize the `products` list in main() with your own products.
"""
...
def main():
    ...
    # -------------------------------------------------------
    # CUSTOMIZE THESE PRODUCTS WITH YOUR OWN OFFERINGS
    # -------------------------------------------------------
    products = [
        {
            "title": "AI Text Generation API Access (100 requests)",
            "description": (
                "Get 100 API calls to a local Ollama AI inference server. "
        ...
        },
        {
            ...
            "description": (
                "A custom AI-powered bot for your Nostr profile.\n\n"
                "Features:\n"
                ...
                "DM after purchase to discuss your requirements."
            ),
            "price_sats": 10000,
            "category": "service",
