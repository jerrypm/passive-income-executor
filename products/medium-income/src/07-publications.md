...
|------|-------|-----------------|----------------|-------|
| Better Programming | Tech/software | Curation (form) | Y | Weekly turnaround; strong developer audience |
| The Startup | Business/startups | Invitation | Y | Slower turnaround; one of Medium's largest publications |
| In Plain English | General/tech | Curation (form) | Y | Family of 5+ niche pubs; high reach across topics |
| ILLUMINATION | General writing | Free (open) | Y | Fast turnaround; good for first publication credits |
| Better Humans | Self-improvement | Invitation | Y | High editorial bar; evidence-based angle preferred |
| UX Collective | Design/UX | Curation (form) | Y | Top design pub on Medium; strong Boost nomination history |
| JavaScript in Plain English | JavaScript | Curation (form) | Y | Part of the In Plain English family; JS-specific focus |
| ITNEXT | Developer-focused | Curation (form) | Y | Strong DevOps, backend, and cloud coverage |
| Level Up Coding | General dev | Curation (form) | Y | Broad developer audience; tutorials perform well here |
| AI in Plain English | AI/ML | Curation (form) | Y | Fast-growing; part of the In Plain English family |
| Write A Catalyst | Writing/personal growth | Free (open) | Y | Open submissions; writing-about-writing pieces welcome |
| The Writing Cooperative | Writing craft | Curation (form) | Y | Craft-focused; essays on process and the writing life |
| Mind Cafe | Mental health/mindfulness | Curation (form) | Y | Large following; personal essay format performs well |
| The Ascent | Personal development | Curation (form) | Y | Practical self-improvement; actionable angle preferred |
| Towards Data Science | Data science/ML | Invitation/application | Y | Highly selective; one of Medium's most-read tech pubs |
| HackerNoon on Medium | Tech/startups | Curation (form) | N | HackerNoon has its own platform; verify current status |
| Python in Plain English | Python | Curation (form) | Y | Part of the In Plain English family; tutorials do well |
| Towards AI | AI/ML research | Curation (form) | Y | Research and applied AI; longer-form pieces do well |
| The Bold Italic | San Francisco/lifestyle | Invitation | N | Regional focus; verify current activity before pitching |
| Personal Growth | Self-improvement | Free (open) | Y | High volume; productivity and habits content |
| The Post-Grad Survival Guide | Career/finances | Curation (form) | Y | Strong millennial/Gen Z readership |
| Entrepreneurship Handbook | Entrepreneurship | Curation (form) | Y | Founder stories and business lessons format |
| DataDrivenInvestor | Finance/investing | Curation (form) | Y | Fintech and personal finance; data-backed angles work |
| Curious | General interest/science | Curation (form) | Y | Broad audience; science explainers and big ideas |
| Elemental | Health/wellness | Invitation | N | Verify current activity — editorial status changes |
| Forge | Productivity/work | Invitation | N | Verify current activity — editorial status changes |
| MakeItNew | Creativity/design | Curation (form) | Y | Creative process and design thinking |
| Startup Grind | Startups/founder stories | Curation (form) | Y | Founder interviews and lessons-learned format |
| Publishous | General writing | Free (open) | Y | Open submissions; lifestyle and personal essays |
| CodeX | Programming/tutorials | Curation (form) | Y | Code tutorials and developer tools coverage |
...
`Pitch: [Article Title] for [Publication Name]`

**Body template:**

> **Para 1 — Who you are (1–2 sentences):**
> I'm [name], a [role/niche] writer who has been publishing on Medium since [year]. [One credibility marker: recent publication credit, Boost nomination, or specific stat.]
>
> **Para 2 — The article (2–3 sentences):**
> I'd like to pitch "[Article Title]" for [Publication Name]. The piece covers [core topic] through the angle of [specific hook], which fits your audience because [one reason — reference a recent pub piece or their stated focus]. The draft is approximately [word count] words.
>
> **Para 3 — Soft ask (1–2 sentences):**
> Happy to revise before submission — let me know if the angle needs adjusting. Working draft: [link].
>
