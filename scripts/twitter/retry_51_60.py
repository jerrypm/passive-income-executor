#!/usr/bin/env python3
"""Retry posting Part 51-60 to Twitter via Chrome Profile 10."""
...
def post_twitter(text, part_num):
    """Post tweet via Chrome Profile 10 using compose URL."""
    # Open compose URL directly in existing x.com tab or new tab
    script_open = '''
...
def main():
    log("=== RETRY ALL Part 51-60 ===")

    # Open Chrome Profile 10 with x.com first
    subprocess.run([
