...
TOPICS = [
    ...
    "how Honeygain lets you earn passive income by sharing unused bandwidth — sign up at https://join.honeygain.com/JERRYF5C2E for a $5 bonus",
    "why bandwidth sharing apps like Honeygain are the easiest passive income for devs — try it: https://join.honeygain.com/JERRYF5C2E",
    "a tip about stacking multiple passive income streams as a developer, including bandwidth sharing with Honeygain (https://join.honeygain.com/JERRYF5C2E)",
]
...
def main():
    ...
    if not privkey:
        print("Error: NOSTR_PRIVKEY not found")
        sys.exit(1)
